...
import { IDadoConsolidadoFiltro } from "./dado-consolidado-filtro.interface";
...
export class InvestimentoFiltroComponent implements AfterViewInit{
    ...
    @Output() public filterChange = new EventEmitter<Partial<IDadoConsolidadoFiltro>>();
    ...
    filtro : Partial<IDadoConsolidadoFiltro> = {};
