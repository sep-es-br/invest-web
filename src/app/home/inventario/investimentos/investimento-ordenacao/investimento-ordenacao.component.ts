...
@Component({
    selector: 'spo-investimento-ordenacao',
    templateUrl: './investimento-ordenacao.component.html',
    styleUrl: './investimento-ordenacao.component.scss',
    imports: [
        CommonModule, CampoOrdenacaoComponent, ReactiveFormsModule, FontAwesomeModule, FormsModule
    ]
})
export class InvestimentoOrdenacaoComponent implements AfterViewInit {
