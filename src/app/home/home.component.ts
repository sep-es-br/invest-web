...
export class HomeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (screen.width < 940) this.isMenuVisible = false;
  }
  ...
  handleScreenOrMenuClick() {
    if (screen.width < 940 && this.isMenuVisible) {
      // Está no "modo responsivo" e o menu está aparecendo
      this.ocultarMenu();
    }
  }
}