...
export class ContaService {
    ...
    public findAllTira(filtro : InvestimentoFiltro) : Observable<InvestimentoTiraDTO[]> {
        return this.http.get<InvestimentoTiraDTO[]>(`${this.contaApi}/contaTira`, {params: this.filterToParams(filtro)})
    }

    public getCount(filtro : InvestimentoFiltro) : Observable<number> {
        return this.http.get<number>(`${this.contaApi}/count`, {params: this.filterToParams(filtro)})
    }
